...
//        }
    ...
    @PostMapping("/fundtransfer/external-citad")
    public ResponseModel FundTransferExternalNapas(@RequestBody RequestModel requestModel) {
        ...
        responseModel.setCity_id(requestModel.getCity_id());
        responseModel.setBranch_id(requestModel.getBranch_id());
    ...
    @PostMapping("/fundtransfer/external-citad-verify")
    public VerifyResponseModel FundTransferExternalNapasVerify(@RequestBody VerifyRequestModel verifyRequestModel) {
        ...
        verifyResponseModel.setCity_id(verifyRequestModel.getCity_id());
        verifyResponseModel.setBranch_id(verifyRequestModel.getBranch_id());
